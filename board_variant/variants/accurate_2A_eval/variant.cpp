...
const PinDescription g_APinDescription[] =
{
  ...
  // 22 - SERCOM/UART (Serial2)
  // ----------------------
  { PORTA, 12, PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_11 }, //SERCOM2/PAD[0]
  ...
  // 38 - SERCOM/UART (Serial2)
  { PORTA, 13, PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_10 }, //SERCOM2/PAD[1]
